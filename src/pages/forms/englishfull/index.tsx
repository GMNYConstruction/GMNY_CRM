...
const index = () => {
  widthRedirects(
    "https://na4.documents.adobe.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhA1nYYRJgfM6dN4D8MJmNJeM1enpC_FHi5b0IpOdZUAC2uQrk_s5AJ5bpS179qDNjg*&hosted=false"
  );
  return (
